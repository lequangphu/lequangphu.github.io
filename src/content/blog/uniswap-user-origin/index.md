...
description: "Analysis of how users access Uniswap through different trading routes"
date: "2023-08-01"
---
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-1.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-2.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-3.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-4.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-5.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-6.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-7.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-8.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-9.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-10.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-11.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-12.webp)

Weekly trader growth rate of the routes range between 5% (MEV) and 5.8% (Unknowns).

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-13.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-14.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-15.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-16.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-17.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-18.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-19.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-20.webp)
...
-   Unknowns: This holds 11% of the volume share. This portion of the volume is not categorized or identified, suggesting some level of uncertainty or miscellaneous routing in the stable pool transactions.

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-21.webp)
...
-   The 'Unknowns' category does not show a significant difference between stable and all pools, suggesting that this category may encompass various minor or less categorized routing behaviors.

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-22.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-23.webp)

MEV traders tend to trade more in this pool than those of the other routes.

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-24.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-25.webp)

Aggregators traders tend to trade more in this pool than those of the other routes.

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-26.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-27.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-28.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-29.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-30.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-31.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-32.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-33.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-34.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-35.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-36.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-37.webp)

## MEV

Volume of top 10 volume traders range between $7B+ and $16B+. Top 10 traders account for $14 in every $100 of total MEV volume.

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-38.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-39.webp)

Number of trade of top 10 volume traders range between 4K+ (8th trader) and 103K+ (4th trader).

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-40.webp)

Volume per trade of top 10 volume traders range between $76K+ (10th trader) and $2M (8th trader).

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-41.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-42.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-43.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-44.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-51.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-52.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-53.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-54.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-55.webp)
...
![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-56.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-57.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-58.webp)

![](/assets/crypto/uniswap-user-origin/uniswap-user-origin-59.webp)
