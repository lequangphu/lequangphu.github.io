...
2.  Overall, Uniswap's liquidity is very concentrated. As (1) 2.8% of all LPs, whose accounts are contract account, added 94% of total liquidity volume. And (2) 7 largest LPs, 0.0007% of total number of LP, added 80% of total liquidity of Uniswap. Liquidity of Uniswap on Ethereum is more concentrated than that of Uniswap on L2s.
...
4.  On average, LPs, who are contract account, have bigger total number of mint (11x), larger liquidity volume per mint (47x), and are more active (3x) than LPs, who are externally-owned account (EOA).
...
*Mint frequency is number of day per mint. This definition is actually the inversion of the normal definition of frequency. I use it to better show data on visualization. The **larger** the frequency, the **less active** LPs are.*
