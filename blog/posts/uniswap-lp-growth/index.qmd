...
2.  Overall, Uniswap's liquidity is very concentrated. As (1) 2.8% of all LPs, whose accounts are contract account, added 94% of total liquidity volume; (2) 7 largest LPs, 0.0007% of total number of LP, added 80% of total liquidity volume to Uniswap; and (3) the level of liquiditiy concentration is increasing over time. Additionally, liquidity of Uniswap on Ethereum is more concentrated than that of Uniswap on L2s.
...
5.  97% of LPs are EOA, however, their contribution in total liquidity is very small. My suggestion is try encouraging EOA LPs to have at least 2 mints within the first 2 weeks.
...
<iframe src="https://dune.com/embeds/3147289/5249472" width="100%" height="400"></iframe>

Of all EOAs, who minted at least twice, 77% of them have the second mint within 336 hours [= 2 weeks] since the first mint.

<iframe src="https://dune.com/embeds/3149962/5254482" width="100%" height="400"></iframe>

When compare % LP completed the first 2 mints within 2 weeks (`% LP, aggregate`), and number of hours between the first 2 mints which 80% of LPs  between each total number of mint bucket, we can see that:
...
<iframe src="https://dune.com/embeds/3150011/5254530" width="100%" height="400"></iframe>

What we learned here suggests that Uniswap builders should try encouraging EOA LPs to have at least 2 mints within the first 2 weeks. Perhaps by messaging them through a wallet application. The best option is through Uniswap wallet, where Uniswap builders have more control. This requires EOA LPs to switch to Uniswap wallet in the first place.