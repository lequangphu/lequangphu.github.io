...
EOAs, who mint 10 times or less, account for 91% of total number of EOAs. Up to 9 mints, as number of mint increases, % share of number of LP of each mint bucket in total number of LP decreases, however, % share of liquidity volume of each mint bucket in total liquidity volume basically flats, which means liquidity volume per LP increases. Indeed, relative to liquidity per LP of single mint LPs, that of 2-mints LPs is 5x larger, of 3-mints LPs is 9x larger, and so on. If Uniswap builders can find a way to nudge a single-mint LP to have another liquidity mint, it will potentially 5x the LP's total liquidity volume.
