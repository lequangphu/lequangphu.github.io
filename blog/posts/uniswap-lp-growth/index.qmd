...
2.  Overall, Uniswap's liquidity is very concentrated. As (1) 2.8% of all LPs, whose accounts are contract account, added 94% of total liquidity volume; (2) 7 largest LPs, 0.0007% of all LP, added 80% of total liquidity volume to Uniswap; and (3) percentage in monthly liquidity volume of top 1% LPs increased from 17% (in 2019) to 99% (in 2023). Additionally, liquidity of Uniswap on Ethereum is more concentrated than that of Uniswap on L2s.
