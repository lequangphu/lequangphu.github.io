...
What we learned here suggests that Uniswap builders should try encouraging EOA LPs to have at least 2 mints within the first 2 weeks. Perhaps by messaging them through a wallet application such as Uniswap wallet, which requires EOA LPs to switch to Uniswap wallet in the first place.