...
At high level, the battle of crypto exchanges consists of 2 parts: Liquidity and Trade. A trade cannot happen without liquidity. Competing for liquidity is the first half of the battle.
...
Last 12 months, for every 100 trades on DEXs, at least 96 trade processed by Constant Product (i.e. AMM), and Hybrid mechanisms.

<iframe width="100%" height="420" frameborder="0" src="https://embed.theblockcrypto.com/data/decentralized-finance/dex-non-custodial/dex-mechanism-volume-share/embed" title="DEX Mechanism Volume Share"></iframe>
...
Although Defillama data on DEX and CEX might miss a few exchanges in each category, the fact that crypto market has 842 DEXs and 28 CEXs, or 30:1 DEX to CEX, and DEX is 8 years younger than CEX, is quite astounding. This implies that the entry bar to DEX is much lower than the entry bar to CEX.
...
-   And the providers are noticably more active in Q1 than Q2. One possible reason is APY of Uniswap pools were higher in Q1 than that in Q2, as seen in the Uniswap Median APY chart below.
...
Have you noticed that the range of total assets moved per day on Uniswap was much larger than those on the CEXs, especially relative to total assets? With this data point, one may conclude that total assets on Uniswap fluctuates more wildly than those on the CEXs. However, it's not true as seen [above](https://lequangphu.github.io/blog/posts/uniswap-vs-cex/#assets-in-h1-2023), and also is demonstrated by net assets inflow in the next section. The possible reasons, in my opinion, are:
...
-   And finally, CEXs limit the amount of assets per withdraw depends on a user tier, while Uniswap does not. This can be observed in the chart of assets removed per transaction below.

In H1 2023, on average, Uniswap total assets removed per transaction is $113K, which is 9 times higher than those of Binance, OKX. Bitfinex total assets removed per transaction, on the other hand, is even higher than that of Uniswap. This makes sense as Bitfinex users are usually high networth users (i.e. whales).
...
![Binance]('blog/posts/uniswap-vs-cex/Binance Withdrawal Limits.JPG')

*source: [binance.com](https://www.binance.com/en/fee/vip).*

![OKX]('blog/posts/uniswap-vs-cex/OKX Withdrawal Limits.JPG')
...
-   Uniswap market share, as the largest DEX, started with 56.21% in July 2022, and ended slightly higher with 58.51% in June 2023, or 1% increase.
...
-   Binance market share, as the largest CEX, started with 47% in July 2022, and ended slightly higher with 48.98% in June 2023, or 1% increase.
