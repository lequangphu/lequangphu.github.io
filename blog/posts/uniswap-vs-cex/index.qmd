...
*In this section, the CEXs assets are from a list of EVM wallets extracted from [Defillama Github Repo](https://github.com/DefiLlama/DefiLlama-Adapters/tree/main/projects).*
...
-   Assets providers of Uniswap moved their assets 8.7 times per week (i.e. more than once a day), which is more than 8 times higher than once a week of those on Binance and OKX, and more than triple that on Bitfinex.
