...
In H1 2023, on average, an assets provider of Uniswap removed $623K assets per day, which is 40 times higher than those removed from Binance and OKX, and more than 2 times higher than those removed from Bitfinex. The situation is quite similar in average assets added per assets provider per day.
...
*To measure how active an asset provider is, let's examine number of assets movement (add + remove) the asset provider did per week (i.e frequency) in H1 2023.*

In H1 2023:

-   Uniswap assets providers are much more active in managing their assets than those on the 3 CEXs, which can be observed by number of assets movement (add + remove) per week.

-   Assets providers of Uniswap, on average, moved their assets 8.7 times per week, which is more than 8 times higher than those on Binance and OKX, and more than 3 times higher than that on Bitfinex.
