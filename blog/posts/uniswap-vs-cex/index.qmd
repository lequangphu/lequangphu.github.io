...
It's been 14 years since the Bitcoin's genesis block mined, 13 years since the first CEX founded, and almost 4 years since the first DEX founded. Before progressing to the end of this post, please keep some data points below in mind:
...
In top 10 exchanges, only 2 of them are DEX, which are Uniswap, and Curve, at 4th and 5th position respectively.
...
Since Uniswap only supports EVM compatible chains (EVM), let's dive deeper into these chains.

### EVM Assets

*In this section, let's examine assets by token, and their flow in/out of each exchange.*
