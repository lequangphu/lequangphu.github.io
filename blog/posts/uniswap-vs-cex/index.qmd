...
-   Binance active providers per day grew more than 2 times from 54.7K to 123.6K. It mostly ranged between 60K and 180K, along with a few huge surges to as high as 712.5K (on May 19).

<iframe src="https://dune.com/embeds/2689017/4472367" width="100%" height="400">

</iframe>

-   Uniswap active providers per day grew 18% from 4.9K to 5.8K. However, the trend in Q2 was actually down as it increased and peaked in late March. This strongly correlates with Uniswap pools Median APY [above](https://lequangphu.github.io/blog/posts/uniswap-vs-cex/#inout).
...
-   Binance total trade volume per day grew 27% from \$6.7B to \$8.5B. It ranged between \$5.6B (on May 22) and \$28.4B (on March 19, stablecoins depeg event), or max down 17% and max up more than 4 times.

-   Coinbase total trade volume per day has a similar range to that on Uniswap in most part of the period. However, it grew 26% from \$873M, about 2 times higher than that of Uniswap, to \$1.1B. It ranged between \$670M (on May 23, similar to Binance) and \$2.5B (on January 18). One interesting data point is, unlike Uniswap and Binance, Coinbase total trade volume per day did not make the highest high during the stablecoins depeg event. This might due to the fact that Coinbase tokens are mostly quoted in USD (instead of USDT on other CEXs).
