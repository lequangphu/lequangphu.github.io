...
We learned above that on average, daily average % IL of Uniswap V3 ranged between 0.002% and 0.042%. In 2.9K pools, which had reserve, and price data, out of every 100 pools, 60 pools had % IL ranged between 0.002% and 0.04%, 31 pools had % IL greater than 0.04%, 9 pools had % IL less than 0.002%.
