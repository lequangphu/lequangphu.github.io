...
### Top Profit [IL + fee] pools

*Let's add trading fee into the equation to see which pool generate the most profit from $1 of liquidity.*
...
Meanwhile, % IL ranged between 99.3% (`XFUND-WETH : 0.3%`) and 134.9% (`WBTC-VERSE : 1%`).
