...
2.  About trade size:
    ...
    -   There is a risk of having too much volume from a few large traders. Arbitrum exposes the most, whereas Base exposes the least to the risk.
...
6.  About frequency of listing:
    ...
    -   Creating more pools and listing more new tokens increasing more option for traders to trade, mitigating volume concentration risk. And Polygon and Base have done the most, whereas Celo and Avalanche have done the least of that.
