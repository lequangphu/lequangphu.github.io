...
At its peak, meme pools acounted for 42% in total trading volume per day, almost 80% in total trader per day, and total transaction per day.
...
I use retention rate to measure traders stickiness. Retention rate is % of a trader cohort return (to swap on Uniswap). Retention rate of meme traders in the first 3 weeks is 2x of Uniswap average. However, from week 4th, the trend appears to drop faster than Uniswap average.
