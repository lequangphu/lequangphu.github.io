...
As of May 31, 2023, there are 850 meme coins listed on [Coinmarketcap](https://coinmarketcap.com/view/memes/).
...
WETH is the highest base token (token0), and the highest quoted token (token1) in term of # pool. In both ranks, WETH leads with a large margin vs. the followings tokens.
...
In other words, for every 2 pools created where base tokens are meme, another pool created where quoted token is meme. And for every 2-3 pools created where quoted tokens are WETH, USDC, another pool created where base token is one of them.

## On Other Pool

Though trading activities in other pools have been down. There is no clear adverse effects of meme pools on other pools. We even saw favorite effects as we learned that meme coins attracted new traders to Uniswap V3 and when they returned, they also traded in other pools.

As volume in meme pools surged, volume in other pools also surged. And in those surges, other pools' peaks lagged those of meme pools 1 day (as seen on May 5 and May 23). This could be resulted of meme traders exitting their meme position to major coins.

<iframe src="https://dune.com/embeds/2492014/4310887" width="800" height="400"></iframe>

The favorite effects of meme pools on other pools are very small in # trader and # trade.
