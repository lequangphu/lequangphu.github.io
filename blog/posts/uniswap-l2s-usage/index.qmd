...
6.  In characteristics of retention: (1) 4 L2s have \> 10% median week 1 retention (week 0 is the first week) including Arbitrum, Optimism, Polygon and Celo; (2) Accross all cohorts, week 1 retention rate, on Avalanche, Base, and BNB, are quite uniform, whereas, on Optimism, Arbitrum, Celo, and Polygon vary wildly.

7.  In characteristics of frequency of listing: (1) for every 10 pools created, 6 pools have tokens listed for the first time; (2) 60% of all tokens listed have prices of \$0.01 or less, most of them are likely meme, and the dominance of `<= $0.01` tokens fueled by the launch of Uniswap on Base.

8.  In characteristics of volume through Uniswap's frontend: (1) traders on Optimism tend to trade through Uniswap frontend more than those on other L2s; (2) surprisingly, the share of Uniswap frontend in monthly volume accross L2s have been decreasing, except for Avalanche.
...
<iframe src="https://dune.com/embeds/3203895/5355322" width="100%" height="300">
