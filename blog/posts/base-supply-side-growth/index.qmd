...
fig.add_trace(
    go.Bar(
        ...
        hovertemplate='<br><b>Date:</b> %{x| %b-%d} <br>'
                      '<b>Total Transactions:</b> %{y:,.0f} <br>'
                      '<b>Fail Transactions:</b> %{customdata[2]:,.0f} <br>',
...
fig.update_layout(
    ...
    yaxis=dict(title='Total Transactions', tickformat=',.0f'),
    yaxis2=dict(title='Fail Rate', tickformat='.0%'),
...
fig.update_layout(
    xaxis=dict(title='Date', tickformat='%b-%d'),
    yaxis=dict(title='Aggregate Contracts', tickformat=',.0f'),
...
fig.update_layout(
    xaxis=dict(title='Date', tickformat='%b-%d'),
    yaxis=dict(title='Conversion Rate', tickformat='.1%', range=[0, 1]),
...
fig.update_traces(hovertemplate='<b>Date:</b> %{x}<br><b>Aggregate Developers:</b> %{y:,.0f}')
