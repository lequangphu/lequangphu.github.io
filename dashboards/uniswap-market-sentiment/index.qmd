...
::: {.card title="State in December 2023"}
On one hand, after 2021 bull, 1 million transaction per day, a new baseline of network demand on Ethereum is established. On the other hand, transaction fee still fluctuated wildly from bull to bear. In the 2021 bull market, transaction fee mostly stayed aboved 10$ per transaction. In December 2023, the level has been reached, however, whether it can be sustained or not remains to be seen.
:::
...
### address balance {.tabset title="Address Balance"}
...
::: {.card title="State in December 2023"}
How is the sentiment on Ethereum?
:::
