...
Impermanent loss when providing liquidity in a pool happened when prices of tokens in the pool change, read more [here](https://support.uniswap.org/hc/en-us/articles/20904453751693-What-is-Impermanent-Loss-). ETH price volatility of a given day is the absolute percentage difference between price of the day and the previous day.
